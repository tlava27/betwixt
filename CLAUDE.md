...
- **Content:** 79 puzzles (56 from round 1, curated; 23 from round 2, kept as-generated with no curation pass) — not 50, that interview-stage target was revised twice since. All in `puzzle-candidates.md` and `puzzles.js`. Once a player exhausts all 79 days, show: "Thanks for testing the beta! More puzzles to be added soon." — never loop back to puzzle #1.
